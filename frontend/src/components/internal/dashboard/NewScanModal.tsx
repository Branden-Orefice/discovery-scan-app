...
const newScanModalModules = [
  ...
  },
  {
    ...
    description: "Match Against Wordfence CVE DB",
    tooltip:
      "Attempts to identify vulnerabilities based on detected versions of WordPress core, plugins, and themes. It uses the Wordfence vulnerability database to find known CVEs associated with those components.",
    checked: false,
  },
  {
    id: 4,
